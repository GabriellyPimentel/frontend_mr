          ...
          <CampoComErro error={errors.endereco?.message}>
            <input
              ...
              style={{
                ...
                backgroundColor: errors.endereco ? '#fef2f2' : '#F9F4ED'
              }}
              onFocus={(e) => {
                if (!errors.endereco) {
                  e.target.style.borderColor = '#4B6043';
          ...
          <CampoComErro error={errors.rendaMensal?.message}>
            <input
              ...
              style={{
                ...
                backgroundColor: errors.rendaMensal ? '#fef2f2' : '#F9F4ED'
              }}
              onFocus={(e) => {
          ...
          <CampoComErro error={errors.situacaoTrabalho?.message}>
            <select
              ...
              style={{
                ...
                backgroundColor: errors.situacaoTrabalho ? '#fef2f2' : '#F9F4ED'
              }}
              onFocus={(e) => {
          ...
          <CampoComErro error={errors.escolaridade?.message}>
            <select
              ...
              style={{
                ...
                backgroundColor: errors.escolaridade ? '#fef2f2' : '#F9F4ED'
              }}
              onFocus={(e) => {
